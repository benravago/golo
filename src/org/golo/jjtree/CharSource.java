 ...
 */
  CharSource(java.io.Reader dstream,
...
/** Constructor. */
  CharSource(java.io.InputStream dstream, String encoding, int startline,
 ...
 * @param buffersize size of the buffer
 */
  CharSource(java.io.InputStream dstream, int startline,
 ...
 * @throws UnsupportedEncodingException encoding is invalid or unsupported.
 */
  CharSource(java.io.InputStream dstream, String encoding) throws java.io.UnsupportedEncodingException
  {
   ...
   * @param dstream the underlying data source.
   */
  CharSource(java.io.InputStream dstream)
  {
    this(dstream, 1, 1, 4096);
  }
