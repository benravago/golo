...
*/
  ...
  Symbol addConstant(Object value) {
    if (value instanceof Integer i) {
      ...
      return addConstantMethodHandle(h.tag, h.owner, h.name, h.descriptor, h.isInterface);
    } else if (value instanceof ConstantDynamic cd) {
      return addConstantDynamic(cd.name, cd.descriptor, cd.bootstrapMethod, cd.bootstrapMethodArguments);
    } else {
...
*/
  ...
  Symbol addBootstrapMethod(Handle bootstrapMethodHandle, Object... bootstrapMethodArguments) {
    ...
    bootstrapMethodsAttribute.putShort(addConstantMethodHandle(bootstrapMethodHandle.tag, bootstrapMethodHandle.owner, bootstrapMethodHandle.name, bootstrapMethodHandle.descriptor, bootstrapMethodHandle.isInterface).index);
