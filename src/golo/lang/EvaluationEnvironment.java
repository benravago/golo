...
public class EvaluationEnvironment {
   ...
   * @see golo.lang.Predefined#fun(Class, Object, Object)
   */
   ...
   * @return the function as a {@link golo.lang.FunctionReference} instance.
   */
  ...
  private Class<?> wrapAndLoad(String source, String... argumentNames) {
    StringBuilder builder = new StringBuilder().append(anonymousModuleName()).append("\n");
