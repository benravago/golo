...
import static golo.lang.Predefined.require;
...
public final class IO {
  ...
  public static void textToFile(Object text, Object file, Object charset) throws Throwable {
    ...
    if ("-".equals(file.toString())) {
      ...
      Files.write(path, str.getBytes(encoding), StandardOpenOption.WRITE, StandardOpenOption.CREATE,
  ...
  public static PrintStream printStreamFrom(Object output, Object charset) throws IOException {
    ...
    return new PrintStream(new BufferedOutputStream(out), true, toCharset(charset).name());
  }
