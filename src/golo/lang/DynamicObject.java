...
import static golo.lang.Predefined.isClosure;
...
public final class DynamicObject {
  ...
  public static Object dispatchCall(String property, Object... args) throws Throwable {
    ...
    throw new UnsupportedOperationException(
        "There is neither a dynamic object method defined for " + property + " nor a 'fallback' method");
  }
   ...
   * @throws Throwable in case everything is wrong.
   */
  public static Object dispatchDelegate(DynamicObject deleguee, DynamicObject receiver, String property, Object... args)
      throws Throwable {
    return deleguee.invoker(property, genericMethodType(args.length + 1)).bindTo(deleguee).invokeWithArguments(args);
  }
  ...
  public static FunctionReference delegate(DynamicObject deleguee) {
    return new FunctionReference(DISPATCH_DELEGATE.bindTo(deleguee).asVarargsCollector(Object[].class), //.asType(genericMethodType(2, true)),
  ...
  static {
    ...
    try {
      ...
      DISPATCH_GET = lookup.findStatic(DynamicObject.class, "dispatchGetterStyle",
          methodType(Object.class, String.class, DynamicObject.class));
      DISPATCH_SET = lookup.findStatic(DynamicObject.class, "dispatchSetterStyle",
          methodType(Object.class, String.class, DynamicObject.class, Object.class));
