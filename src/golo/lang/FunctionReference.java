 ...
 * @see golo.runtime.ClosureCallSupport
 */
public class FunctionReference {
  ...
  public String toString() {
    return String.format("FunctionReference{handle=%s%s, parameterNames=%s}",
        handle.isVarargsCollector() ? "(varargs)" : "", handle, Arrays.toString(parameterNames));
  }
  ...
  public FunctionReference andThen(FunctionReference fun) {
    ...
    MethodHandle mh = filterReturnValue(this.handle.asType(this.handle.type().changeReturnType(Object.class)),
  ...
  public FunctionReference bindAt(String parameterName, Object value) {
    ...
    if (position == -1) {
      throw new IllegalArgumentException(
          "'" + parameterName + "' not in the parameter list " + Arrays.toString(parameterNames));
    }
