...
public final class Result<T, E extends Throwable> implements Iterable<T> {
  ...
  */
  public static <T> Result<T, NoSuchElementException> option(Optional<T> opt, String message) {
    return (opt == null || !opt.isPresent()) ? new Result<>(null, new NoSuchElementException(message))
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, that.value) && (Objects.equals(this.error, that.error)
        || (this.error.getClass() == that.error.getClass() && this.error.getMessage().equals(that.error.getMessage())));
  }
  ...
  /**
   * Return a {@link golo.lang.Tuple} representing this {@code Result}.
   *
