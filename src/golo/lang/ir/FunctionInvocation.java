...
public final class FunctionInvocation extends AbstractInvocation<FunctionInvocation> {
   ...
   * @see #of(Object)
   */
  public static FunctionInvocation create(String name, boolean onReference, boolean onModuleState, boolean constant,
      Object... args) {
    return of(name).onReference(onReference).onModuleState(onModuleState).constant(constant).withArgs(args);
  }
  ...
  protected FunctionInvocation copy() {
    return create(anonymous ? null : getName(), onReference, onModuleState, constant, getArguments().toArray());
  }
