...
public abstract class GoloElement<T extends GoloElement<T>> {
   ...
   * Note that if the ancestor can be the element itself.
   */
  public GoloElement<?> ancestor(golo.lang.FunctionReference predicate) {
   ...
   * Returns a list of all the descendants of this node matching the given predicate.
   */
  public List<GoloElement<?>> descendants(golo.lang.FunctionReference predicate) {
    // NOTE: this implementation is required due to some bugs in the implicit conversion of golo function references
    // into java lambda (see https://github.com/eclipse/golo-lang/issues/277)
  ...
  public Stream<GoloElement<?>> descendants() {
    return Stream.concat(children().stream(), children().stream().flatMap(GoloElement::descendants));
  }

  private static Predicate<GoloElement<?>> predicateWrapper(golo.lang.FunctionReference predicate) {
    return n -> {
      try {
   ...
   */
  public List<GoloElement<?>> children(golo.lang.FunctionReference predicate) {
    // NOTE: this implementation is required due to some bugs in the implicit conversion of golo function references
    // into java lambda (see https://github.com/eclipse/golo-lang/issues/277)
   ...
   * Returns the previous sibling of this element matching the given predicate.
   */
  public GoloElement<?> previous(golo.lang.FunctionReference predicate) {
    // NOTE: this implementation is required due to some bugs in the implicit conversion of golo function references
    // into java lambda (see https://github.com/eclipse/golo-lang/issues/277)
   ...
   */
  public GoloElement<?> next(golo.lang.FunctionReference predicate) {
    // NOTE: this implementation is required due to some bugs in the implicit conversion of golo function references
    // into java lambda (see https://github.com/eclipse/golo-lang/issues/277)
  ...
  protected static final RuntimeException cantConvert(String expected, Object value) {
    return new ClassCastException(String.format("expecting a %s but got a %s", expected,
