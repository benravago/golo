...
import golo.lang.ir.CollectionLiteral.Type;
...
public final class CollectionLiteral extends ExpressionStatement<CollectionLiteral> {
  ...
  public static CollectionLiteral create(Object type, Object... values) {
    CollectionLiteral col = new CollectionLiteral(type instanceof CollectionLiteral.Type ? (CollectionLiteral.Type) type
