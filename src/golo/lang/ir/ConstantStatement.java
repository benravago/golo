...
public final class ConstantStatement extends ExpressionStatement<ConstantStatement> {
  ...
  public static boolean isLiteralValue(Object v) {
    return v == null || v instanceof String || v instanceof Character || v instanceof Number || v instanceof Boolean
        || v instanceof Class || v instanceof ClassReference || v instanceof FunctionRef;
  }
