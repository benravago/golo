...
public class IrTreeDumper implements GoloIrVisitor {
  ...
  public void visitAssignmentStatement(AssignmentStatement assignmentStatement) {
    incr();
    space();
    this.out.append("Assignment: ").append(assignmentStatement.getLocalReference().toString())
  ...
  public void visitDestructuringAssignment(DestructuringAssignment assignment) {
    incr();
    space();
    this.out.format("Destructuring assignement: {declaring=%s, varargs=%s}%n", assignment.isDeclaring(),
  ...
  public void visitMethodInvocation(MethodInvocation methodInvocation) {
    incr();
    space();
    this.out.format("Method invocation: %s, null safe? -> %s%n", methodInvocation.getName(),
  ...
  public void visitClosureReference(ClosureReference closureReference) {
    ...
    if (target.isAnonymous()) {
      ...
      this.out.printf("Closure reference: %s, regular arguments at index %d%n", target.getName(),
