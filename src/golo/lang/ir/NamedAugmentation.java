 ...
 */
public final class NamedAugmentation extends GoloElement<NamedAugmentation>
    implements FunctionContainer, ToplevelGoloElement, NamedElement {
  ...
  public void addFunction(GoloFunction func) {
    if (func.getArity() == 0) {
      throw new IllegalArgumentException(
          message("augment_function_no_args", func.getName(), this.getPackageAndClass()));
    }
