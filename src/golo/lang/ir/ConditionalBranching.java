...
public final class ConditionalBranching extends GoloStatement<ConditionalBranching> {
  ...
  public static ConditionalBranching create(Object condition, Object trueBlock, Object falseBlock, Object elseBranch) {
    return new ConditionalBranching().condition(condition).whenTrue(trueBlock).whenFalse(falseBlock)
  ...
  public String toString() {
    return String.format("if %s %s%s", condition, trueBlock, hasFalseBlock() ? " else " + falseBlock.toString()
