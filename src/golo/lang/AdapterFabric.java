...
import golo.runtime.adapters.AdapterDefinition;
import golo.runtime.adapters.JavaBytecodeAdapterGenerator;
  ...
  public static final class Maker {
    ...
    public Object newInstance(Object... args) throws ReflectiveOperationException {
      ...
      for (Constructor<?> constructor : adapterClass.getConstructors()) {
        ...
        if ((cargs.length == parameterTypes.length)
            || (constructor.isVarArgs() && (cargs.length >= parameterTypes.length))) {
