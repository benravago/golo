...
import golo.lang.ir.GoloFunction;
import golo.runtime.AmbiguousFunctionReferenceException;
import golo.runtime.Extractors;
import golo.runtime.Loader;
import golo.runtime.WithCaller;
...
public final class Predefined {
   ...
   * @return a String.
   *
   * @deprecated Since 3.3, use {@link golo.lang.IO#readln()}. Will be removed in 4.0
   */
  @Deprecated
  public static String readln() throws IOException {
    // TODO: remove in 4.0
    return golo.lang.IO.readln();
  }
   ...
   * @return a String.
   *
   * @deprecated Since 3.3, use {@link golo.lang.IO#readln(String)}. Will be removed in 4.0
   */
  @Deprecated
  public static String readln(String message) throws IOException {
    // TODO: remove in 4.0
    return golo.lang.IO.readln(message);
  }
   ...
   * @return a String.
   *
   * @deprecated Since 3.3, use {@link golo.lang.IO#readPassword()}. Will be removed in 4.0
   */
  @Deprecated
  public static String readPassword() throws IOException {
    // TODO: remove in 4.0
    return golo.lang.IO.readPassword();
  }
   ...
   * @return a String.
   *
   * @deprecated Since 3.3, use {@link golo.lang.IO#readPassword(String)}. Will be removed in 4.0
   */
  @Deprecated
  public static String readPassword(String message) throws IOException {
    // TODO: remove in 4.0
    return golo.lang.IO.readPassword(message);
  }
   ...
   *
   * @deprecated Since 3.3, use {@link golo.lang.IO#secureReadPassword()}. Will be removed in 4.0
   */
  @Deprecated
  public static char[] secureReadPassword() throws IOException {
    // TODO: remove in 4.0
    return golo.lang.IO.secureReadPassword();
  }
   ...
   * @return a character array.
   *
   * @deprecated Since 3.3, use {@link golo.lang.IO#secureReadPassword(String)}. Will be removed in 4.0
   */
  @Deprecated
  public static char[] secureReadPassword(String message) throws IOException {
    // TODO: remove in 4.0
    return golo.lang.IO.secureReadPassword(message);
  }
  ...
  public static void require(Object condition, Object errorMessage) throws IllegalArgumentException, AssertionError {
    ...
    if ((condition instanceof Boolean) && (errorMessage instanceof String)) {
      ...
      throw new IllegalArgumentException(
          new StringBuilder().append("Wrong parameters for require: expected (Boolean, String) but got (")
              .append(condition.getClass().getName()).append(", ").append(errorMessage.getClass().getName()).append(")")
              .toString());
    }
  }
  ...
  private static void checkRangeTypes(Object value, String name) {
    require((value instanceof Integer) || (value instanceof Long) || (value instanceof Character)
        || (value instanceof BigInteger), name + " must either be an Integer, Long, Character or BigInteger");
  }
   ...
   * @param to the upper-bound (exclusive) as an {@code Integer}, {@code Long}, {@code Character} or {@code BigInteger}.
   * @return a range object.
   * @see golo.lang.Predefined#range
   */
   ...
   * @param from the upper-bound (inclusive) as an {@code Integer}, {@code Long}, {@code Character} or {@code BigInteger}.
   * @return a range object.
   * @see golo.lang.Predefined#reversedRange
   * @see golo.lang.Predefined#range
   */
  ...
  public static Object asFunctionalInterface(Object type, Object func) throws Throwable {
    ...
    for (Method method : theType.getMethods()) {
      if (!method.isDefault() && !isStatic(method.getModifiers())) {
        ...
        implementations.put(method.getName(),
            new FunctionReference(dropArguments(((FunctionReference) func).handle(), 0, Object.class),
   ...
   * @return {@code true} if {@code object} is an instance of {@link golo.lang.FunctionReference} {@code false} otherwise.
   */
   ...
   */
  @WithCaller
  public static FunctionReference fun(Class<?> caller, Object name, Object module, Object arity, Object varargs)
      throws Throwable {
    ...
    final List<Method> validCandidates = Extractors.getMethods(moduleClass).filter(candidate).collect(toList());
    ...
    if (validCandidates.size() > 1) {
      ...
      throw new AmbiguousFunctionReferenceException(("The reference to " + name + " in " + module
          + ((functionArity < 0) ? "" : (" with arity " + functionArity)) + " is ambiguous"));
    }
    ...
    throw new NoSuchMethodException(
        (name + " in " + module + (functionArity < 0 ? "" : (" with arity " + functionArity))));
  }
  ...
  public static FunctionReference toFunctionReference(Method targetMethod, int functionArity) throws Throwable {
    String[] parameterNames = Arrays.stream(targetMethod.getParameters()).map(Parameter::getName)
        .toArray(String[]::new);
  ...
  private static Stream<Method> getImportedFunctions(Class<?> source) {
    return Extractors.getImportedNames(source).map(Loader.forClass(source)).filter(Objects::nonNull)
        .flatMap(Extractors::getMethods).filter(Extractors::isPublic);
  }
   ...
   *
   * @deprecated Since 3.3, use {@link golo.lang.IO#fileToText(Object, Object)}. Will be removed in 4.0
   */
  @Deprecated
  public static Object fileToText(Object file, Object encoding) throws Throwable {
    // TODO: remove in 4.0
    return golo.lang.IO.fileToText(file, encoding);
  }
   ...
   *
   * @deprecated Since 3.3, use {@link golo.lang.IO#textToFile(Object, Object)}. Will be removed in 4.0
   */
  @Deprecated
  public static void textToFile(Object text, Object file) throws Throwable {
    // TODO: remove in 4.0
    golo.lang.IO.textToFile(text, file);
  }
   ...
   * @deprecated Since 3.3, use {@link golo.lang.IO#textToFile(Object, Object, Object)}. Will be removed in 4.0
   */
  @Deprecated
  public static void textToFile(Object text, Object file, Object charset) throws Throwable {
    // TODO: remove in 4.0
    golo.lang.IO.textToFile(text, file, charset);
  }
   ...
   *
   * @deprecated Since 3.3, use {@link golo.lang.IO#fileExists(Object)}. Will be removed in 4.0
   */
  @Deprecated
  public static boolean fileExists(Object file) {
    // TODO: remove in 4.0
    return golo.lang.IO.fileExists(file);
  }
  ...
  public static GoloElement<?> special(GoloFunction fun) {
    ...
    if (fun.getArity() == 0 || (fun.isContextualMacro() && fun.getArity() == 1)) {
      throw new IllegalArgumentException(String.format(
          "Special macro `%s` must take at least 1 argument (`expander` would be a good idea…)", fun.getName()));
    }
  ...
  public static GoloElement<?> contextual(GoloFunction fun) {
    ...
    if (fun.getArity() == 0 || (fun.isSpecialMacro() && fun.getArity() == 1)) {
      throw new IllegalArgumentException(String
          .format("Contextual macro `%s` must take at least 1 argument (`self` would be a good idea…)", fun.getName()));
    }
