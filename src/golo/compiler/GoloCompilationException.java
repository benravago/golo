...
public class GoloCompilationException extends RuntimeException {
  ...
  public static final class Problem {
     ...
     */
    public enum Type {
      PARSING, AUGMENT_FUNCTION_NO_ARGS, UNDECLARED_REFERENCE, ASSIGN_CONSTANT, BREAK_OR_CONTINUE_OUTSIDE_LOOP,
      REFERENCE_ALREADY_DECLARED_IN_BLOCK, UNINITIALIZED_REFERENCE_ACCESS, INVALID_ENCODING,
      INCOMPLETE_NAMED_ARGUMENTS_USAGE, AMBIGUOUS_DECLARATION, UNKNOWN_MACRO, MACRO_EXPANSION
    }
  ...
  public static class Builder {
    ...
    public Builder report(Problem.Type type, GoloElement<?> source, String description) {
      exception
          .report(new Problem(type, source != null ? source.positionInSourceCode() : null, description, source, null));
      return this;
    }
    ...
    public Builder report(Problem.Type type, GoloElement<?> source, String description, Throwable cause) {
      exception
          .report(new Problem(type, source != null ? source.positionInSourceCode() : null, description, source, cause));
      return this;
    }
