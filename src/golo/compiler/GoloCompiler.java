...
public final class GoloCompiler {
   ...
   */
  public List<CodeGenerationResult> compile(String goloSourceFilename, Reader sourceCode)
   ...
   */
  public CompilationUnit parse(String goloSourceFilename, GoloParser parser) throws GoloCompilationException {
  ...
  public CompilationUnit parse(File goloSourceFile) throws GoloCompilationException, IOException {
   ...
   */
  public GoloModule check(CompilationUnit compilationUnit) {
  ...
  public GoloModule transform(CompilationUnit compilationUnit) {
  ...
  public GoloModule expand(GoloModule goloModule, boolean recurse) {
    resetExceptionBuilder();
    goloModule.accept(
        new MacroExpansionIrVisitor(classloader, recurse, getOrCreateExceptionBuilder(goloModule.sourceFile())));
    throwIfErrorEncountered();
    return goloModule;
  }
  ...
  public GoloModule refine(GoloModule goloModule) {
    if (goloModule != null) {
      ...
      goloModule.accept(
          new LocalReferenceAssignmentAndVerificationVisitor(getOrCreateExceptionBuilder(goloModule.sourceFile())));
    }
    throwIfErrorEncountered();
    return goloModule;
  }
