...
public final class AugmentationMethod implements Comparable<AugmentationMethod> {
  ...
  public String toString() {
    return String.format("AugmentationMethod<%s,%s,%s,%s>", kind, scope, target, method);
  }
  ...
  public boolean equals(Object o) {
    ...
    return this.kind == that.kind && this.scope == that.scope && this.target.equals(that.target)
