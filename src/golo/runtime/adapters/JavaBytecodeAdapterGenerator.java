...
public class JavaBytecodeAdapterGenerator {
  ...
  public byte[] generate(AdapterDefinition adapterDefinition) {
    ...
    classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_FINAL | ACC_SYNTHETIC, adapterDefinition.getName(), null,
        jvmType(adapterDefinition.getParent()), interfaceTypesArray(interfaces));
  ...
  public Class<?> generateIntoDefinitionClassloader(AdapterDefinition adapterDefinition) {
    try {
      ...
      Method defineClass = ClassLoader.class.getDeclaredMethod("defineClass", String.class, byte[].class, int.class,
          int.class);
