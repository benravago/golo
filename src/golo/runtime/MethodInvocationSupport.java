...
public final class MethodInvocationSupport {
  ...
  static {
    try {
      ...
      CLASS_GUARD = lookup.findStatic(MethodInvocationSupport.class, "classGuard",
          methodType(boolean.class, Class.class, Object.class));

      FALLBACK = lookup.findStatic(MethodInvocationSupport.class, "fallback",
          methodType(Object.class, InlineCache.class, Object[].class));

      RESET_FALLBACK = lookup.findStatic(MethodInvocationSupport.class, "resetFallback",
          methodType(Object.class, InlineCache.class, Object[].class));

      VTABLE_LOOKUP = lookup.findStatic(MethodInvocationSupport.class, "vtableLookup",
          methodType(MethodHandle.class, InlineCache.class, Object[].class));

      OVERLOADED_GUARD_GENERIC = lookup.findStatic(MethodInvocationSupport.class, "overloadedGuard_generic",
          methodType(boolean.class, Class[].class, Object[].class));

      OVERLOADED_GUARD_1 = lookup.findStatic(MethodInvocationSupport.class, "overloadedGuard_1",
          methodType(boolean.class, Class.class, Class.class, Object.class, Object.class));

      OVERLOADED_GUARD_2 = lookup.findStatic(MethodInvocationSupport.class, "overloadedGuard_2",
          methodType(boolean.class, Class.class, Class.class, Class.class, Object.class, Object.class, Object.class));

      OVERLOADED_GUARD_3 = lookup.findStatic(MethodInvocationSupport.class, "overloadedGuard_3",
          methodType(boolean.class, Class.class, Class.class, Class.class, Class.class, Object.class, Object.class,
              Object.class, Object.class));

      OVERLOADED_GUARD_4 = lookup.findStatic(MethodInvocationSupport.class, "overloadedGuard_4",
          methodType(boolean.class, Class.class, Class.class, Class.class, Class.class, Class.class, Object.class,
  ...
  public static CallSite bootstrap(Lookup caller, String name, MethodType type, Object... bsmArgs) {
    ...
    MethodHandle fallbackHandle = FALLBACK.bindTo(callSite).asCollector(Object[].class, type.parameterCount())
        .asType(type);
    callSite.resetFallback = RESET_FALLBACK.bindTo(callSite).asCollector(Object[].class, type.parameterCount())
        .asType(type);
  ...
  public static boolean overloadedGuard_2(Class<?> t1, Class<?> t2, Class<?> t3, Object receiver, Object arg1,
      Object arg2) {
    return receiver.getClass() == t1 && (arg1 == null || arg1.getClass() == t2)
        && (arg2 == null || arg2.getClass() == t3);
  }

  public static boolean overloadedGuard_3(Class<?> t1, Class<?> t2, Class<?> t3, Class<?> t4, Object receiver,
      Object arg1, Object arg2, Object arg3) {
    return receiver.getClass() == t1 && (arg1 == null || arg1.getClass() == t2)
        && (arg2 == null || arg2.getClass() == t3) && (arg3 == null || arg3.getClass() == t4);
  }

  public static boolean overloadedGuard_4(Class<?> t1, Class<?> t2, Class<?> t3, Class<?> t4, Class<?> t5,
      Object receiver, Object arg1, Object arg2, Object arg3, Object arg4) {
    return receiver.getClass() == t1 && (arg1 == null || arg1.getClass() == t2)
        && (arg2 == null || arg2.getClass() == t3) && (arg3 == null || arg3.getClass() == t4)
  ...
  public static Object fallback(InlineCache inlineCache, Object[] args) throws Throwable {
    ...
    if (args[0] == null) {
      if (shouldReturnNull(inlineCache, args[0])) {
        ...
        throw new NullPointerException(
            "On method: " + inlineCache.name + " " + inlineCache.type().dropParameterTypes(0, 1));
      }
    }
    ...
    if (target == null) {
      ...
      InlineCache fallbackCallSite = new InlineCache(inlineCache.callerLookup, "fallback",
          methodType(Object.class, Object.class, Object.class, Object[].class), false);
      Object[] fallbackArgs = { args[0], inlineCache.name, Arrays.copyOfRange(args, 1, args.length) };
