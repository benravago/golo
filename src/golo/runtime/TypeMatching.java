...
public final class TypeMatching {
  ...
  private static final List<Class<?>> NUMBERS = java.util.Arrays.asList(Short.class, Character.class, Integer.class,
  ...
  public static boolean argumentsNumberMatches(int paramsNumber, int argsNumber, boolean isVarArgs) {
    return argsNumber < 0 || (!isVarArgs && paramsNumber == argsNumber)
  ...
  public static boolean argumentsMatch(Method method, Object[] arguments, boolean varargs) {
    Object[] args = Modifier.isStatic(method.getModifiers()) ? arguments : copyOfRange(arguments, 1, arguments.length);
    return isMethodDecorated(method) || (argumentsNumberMatches(method.getParameterCount(), args.length, varargs)
  ...
  public static boolean argumentsMatch(Constructor<?> constructor, Object[] arguments) {
    return argumentsNumberMatches(constructor.getParameterCount(), arguments.length, constructor.isVarArgs())
